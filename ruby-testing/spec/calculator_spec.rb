...
RSpec.describe Calculator do
  ...
  describe "#subtract" do
    ...
    it "returns the difference of more than two numbers (left to right)" do
      calculator = Calculator.new
  ...
  describe "#divide" do
    ...
    it "returns the quotient of more than two numbers (left to right)" do
      calculator = Calculator.new
      expect(calculator.divide(2, 5, 7)).to eql(0.4 / 7.0)
    end
  end
end